...
expect_true(grepl('href="https://fediscience.org/@agile" target="_blank" rel="me noopener">@agile@fediscience.org</a>', agile_html, fixed = TRUE))
expect_false(grepl('class="citation"', agile_html, fixed = TRUE))
