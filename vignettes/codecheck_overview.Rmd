...
3. Experience with Rmarkdown and R is helpful, but not essential.
...
for the new paper to reproduce, and add an extra row at the bottom of
`register.csv`.  Certificate numbers are simply YYYY-NNN where YYYY is
...
specification comments at <https://codecheck.org.uk/spec/config/1.0>.
